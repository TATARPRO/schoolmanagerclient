...
//import '../../Environment/js/jquery-3.2.1.min.js'
//import '../../Environment/js/owl.carousel.min.js'
//import '../../Environment/js/jquery.countdown.js'
//import '../../Environment/js/masonry.pkgd.min.js'
//import '../../Environment/js/magnific-popup.min.js'
//'use strict';
...
(function($) {
	...
	$(document).ready(function(){
		$('.set-bg').each(function () {
			...
			$(this).css('background-image', 'url(../../img/member/5.jpg)');
			// if (bg.contains("../")) {
			// 	var absolute = bg.replace("^.+/img", "").trim()
			// 	$(this).css('background-image', 'url(../../img/member/5.jpg'+ ')');
			// } else {
	...
	// 	Counter
	// --------------------*/
	// $(".counter").countdown("2020/07/01", function(event) {
